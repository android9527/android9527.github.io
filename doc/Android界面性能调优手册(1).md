# Android界面性能调优手册(1)
 ...
 发表于 2017-11-06 | 更新于: 2017-11-08

 字数统计: 6.2k | 阅读时长 ≈ 22 分钟
...
[![draw](http://android9527.com/images/draw/draw_1.png)](images/draw/draw_1.png)

如果你的应用没有在 16ms 内完成这一帧的绘制，假设你花了 24ms 来绘制这一帧，那么就会出现掉帧的情况。
[![draw](http://android9527.com/images/draw/draw_2.png)](images/draw/draw_2.png)
...
- 花了非常多时间重新绘制界面中的大部分东西，这样非常浪费CPU周期；
  [![draw](http://android9527.com/images/draw/draw_3.png)](images/draw/draw_3.png)
