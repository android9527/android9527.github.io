# Handler、Message、MessageQueue随笔
 ...
 发表于 2016-03-04 | 更新于: 2017-07-27 | 分类于 [Android](http://android9527.com/categories/Android/)

 字数统计: 3.9k | 阅读时长 ≈ 18 分钟
...
[![发送消息](http://android9527.com/images/handler/handler_send.jpg)](images/handler/handler_send.jpg)
...
（3）
[![post（Runnable）](http://android9527.com/images/handler/handler_post.jpg)](images/handler/handler_post.jpg)
...
[![移除消息](http://android9527.com/images/handler/handler_remove.jpg)](images/handler/handler_remove.jpg)
...
m1.recycleUnchecked();
[![这里写图片描述](http://android9527.com/images/handler/recycle1.jpg)](images/handler/recycle1.jpg)

m2.recycleUnchecked();
[![这里写图片描述](http://android9527.com/images/handler/recycle2.jpg)](images/handler/recycle2.jpg)

m3.recycleUnchecked();
[![这里写图片描述](http://android9527.com/images/handler/recycle3.jpg)](images/handler/recycle3.jpg)

Message.obtain();
[![这里写图片描述](http://android9527.com/images/handler/obtain_message.jpg)](images/handler/obtain_message.jpg)
